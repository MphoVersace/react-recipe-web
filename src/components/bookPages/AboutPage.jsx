...
const AboutPage = () => {
  return (
    ...
    <p className='md:text-2xl pt-[6rem]'>Welcome to Foodie Favourites, your very own home away from home!</p>
    ...
    <p className='text-xs md:text-sm pl-[24rem] pr-[2rem] mt-[-7rem] '>Foodie Favourites was founded by Mpho & Grace, who combined Mpho's passion for food with Grace's love for cooking, all in one delicious journey.</p>
    <p className='text-xs md:text-sm pt-[0rem] pl-[11rem] w-[25rem]'>Our mission is to bring joy and inspiration to your kitchen. We believe that cooking should be fun, accessible, and rewarding for everyone, whether you're a beginner or a seasoned chef. We believe that food brings people together, and we are excited to be a part of your culinary journey.</p>
    <p className='text-xs md:text-sm pt-[2rem] pl-[10rem] w-[33rem] '>In addition to our recipe collection, we provide cooking tips, meal planning guides, and video tutorials to help you master new techniques and make the most of your time in the kitchen. Thank you for visiting Foodie Favourites. We hope you find inspiration and joy in our recipes, and we look forward to being a part of your kitchen adventures!</p>
    ...
    <img
        src={about4}
        alt="Healthy Recipe One"
        className='absolute bottom-6 right-[28rem] w-[9rem] h-[15rem] rounded overflow-hidden object-cover'
      /> 
    <img
        src={about5}
        alt="Healthy Recipe One"
